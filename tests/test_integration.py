...
@dataclass
class MockEvent:
    """Mock tkinter event for testing."""

    x: int
    y: int


def test_africa_quiz_app_can_be_created() -> None:
...
def test_africa_quiz_app_has_canvas() -> None:
...
def test_africa_quiz_app_can_draw_map() -> None:
...
def test_africa_quiz_app_handles_click() -> None:
...
def test_africa_quiz_app_populates_canvas_geometries() -> None:
...
def test_africa_quiz_app_draws_country_polygons() -> None:
...
def test_main_function_creates_app() -> None:
...
def test_main_function_actually_works() -> None:
...
def test_africa_quiz_app_canvas_is_packed() -> None:
...
def test_africa_quiz_app_binds_click_events() -> None:
...
def test_africa_quiz_app_shows_country_prompt() -> None:
    ...
    # Should have additional text like "Find:" or "Click on:"
    assert len(label_text) > len(current_country)


def test_africa_quiz_app_updates_prompt_after_click() -> None:
    ...
    _initial_prompt = app.prompt_label.cget("text")  # Store for potential future use
...
def test_africa_quiz_app_progresses_to_next_country() -> None:
...
def test_africa_quiz_app_resets_round_when_complete() -> None:
...
def test_africa_quiz_app_labels_colored_countries() -> None:
...
def test_africa_quiz_app_shows_round_completion_message() -> None:
...
def test_africa_quiz_app_uses_proper_aspect_ratio() -> None:
    ...
    assert ratio_diff < 0.3, (
        f"Canvas aspect ratio {canvas_ratio:.2f} too different from "
        f"geographic ratio {geographic_ratio:.2f}"
    )


def test_africa_quiz_app_handles_click_with_quiz_logic() -> None:
